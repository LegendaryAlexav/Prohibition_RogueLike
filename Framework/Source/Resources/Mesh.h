...
namespace fw
{
    ...
    public:
        ...
        void draw(bgfx::ViewId viewID, Uniforms* pUniforms, const Material* pMaterial);

        virtual ivec2 getVertCount() { return { 0 }; }
        virtual vec2 getWorldSize() { return { 0 }; }

        virtual std::vector<vec3>* getPoints() { return nullptr; }
        virtual const float* getYPositions() { return nullptr; }
