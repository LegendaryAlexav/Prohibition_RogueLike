...
namespace fw
{
    ...
    public:
        ...
        InputEvent(DeviceType deviceType, InputState inputState, uint32 keyCode)
        {
        ...
        InputState getDeviceState() { return m_inputState; }
    ...
    {
    public:
        CollisionEvent(GameObject* pObject1, GameObject* pObject2)
        {
            m_pObject1 = pObject1;
            m_pObject2 = pObject2;
        }
        ...
        static EventType getStaticEventType() { return "CollisionEvent"; }
        virtual EventType getType() override { return getStaticEventType(); }

        GameObject* getObject1() { return m_pObject1; }
        GameObject* getObject2() { return m_pObject2; }
